...
class ExperimentStatisticsTest < ActiveSupport::TestCase
  ...
  test 'count_simulations_to_run should return proper value' do
    # given
    experiment_size = 10
    done_simulations = 5
  ...
  test 'makespan should return proper value' do
    # given
    system_throughput = 1
  ...
  test 'target_throughput should return proper value' do
    # given
    simulations_to_run = 1
    time_now = 0
