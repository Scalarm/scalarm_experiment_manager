class DummyFacade < InfrastructureFacade
  ...
  def _simulation_manager_running?(record)
    # TODO
    # czy zakończył się eksperyment, który był wykonywany przez tego independent
  end
  ...
  # independent workers cannot be started as normal workers - they must be downloaded and started manually
